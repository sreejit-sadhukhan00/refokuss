...
function Stripes() {
    var data=[
        ...
        {url:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63c9ce90a51cd75d563689fd_Awwards-logotype-2018%201.svg",number:77},
  ...
  return (
    ...
    {data.map((elem,index)=>(
        <Stripe key={index} url={elem.url} num={elem.number}/>
    ))}
